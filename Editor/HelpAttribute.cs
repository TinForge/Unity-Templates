...
namespace VRVision.EditorUtility
{
	...
	public class HelpDrawer : PropertyDrawer
	{
		...
		/// <summary>
		/// A helper property to check for HeaderAttribute.
		/// </summary>
		HeaderAttribute headerAttribute
		{
			get
			{
				var attributes = fieldInfo.GetCustomAttributes(typeof(HeaderAttribute), true);
				return attributes != null && attributes.Length > 0 ? (HeaderAttribute) attributes[0] : null;
			}
		}
